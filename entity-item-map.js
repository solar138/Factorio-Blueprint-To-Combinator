...
const entityItemMap = {
    "bob-red-inserter": { item: "long-handed-inserter" },
    "chute-miniloader-inserter": { item: "chute-miniloader" },
    "concrete-wall-ruin": { item: "concrete-wall" },
    "curved-rail-a": { item: "rail", count: 3 },
    "curved-rail-b": { item: "rail", count: 3 },
    "curved-rail": { item: "rail", count: 4 },
    "elevated-curved-rail-a": { item: "rail", count: 3 },
    "elevated-curved-rail-b": { item: "rail", count: 3 },
    "elevated-half-diagonal-rail": { item: "rail", count: 2 },
    "elevated-straight-rail": { item: "rail" },
    ...
    "half-diagonal-rail": { item: "rail", count: 2 },
    ...
    "se-core-miner": { item: "se-core-miner-drill" },
